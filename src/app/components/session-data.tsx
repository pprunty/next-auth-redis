...
export default function SessionData({ session }: { session: Session | null }) {
  if (session?.user) {
    return (
      <div className="flex w-full flex-col gap-4 rounded-md bg-gray-100 p-4 dark:bg-gray-900 dark:text-gray-100">
        ...
        {Object.keys(session.user).length > 3 ? (
          ...
          <p>
            In this example, only some fields in the user object are passed to
        ...
        <div className="flex flex-col rounded-md bg-neutral-100 dark:bg-neutral-800">
          <div className="rounded-t-md bg-neutral-200 p-4 font-bold dark:bg-neutral-700">
            Session
          </div>
  ...
  return (
    <p className="w-full rounded-md bg-gray-100 p-4 dark:bg-gray-900 dark:text-gray-100">
